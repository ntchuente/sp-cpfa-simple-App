...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 6315 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 2558 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 7332 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 21651 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 13589 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 12197 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 7842 };
      jobHistory.job = job;
      const department: IDepartment = { id: 30345 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 9682 };
      jobHistory.employee = employee;
