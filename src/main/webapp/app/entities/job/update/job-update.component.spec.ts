...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 2389 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 15570 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 8063 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 4785 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 13078 };
      job.tasks = [task];
      const employee: IEmployee = { id: 29551 };
      job.employee = employee;
